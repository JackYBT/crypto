...
contract RamonToken is IERC20 {
    using SafeMath for uint;

    string public constant symbol = 'RAM';                 // TODO: Give your token a symbol
    string public constant name = 'RamonToken';                   // TODO: Give your token a name
    ...
    function _mint(uint amount) 
        ...
        AdminOnly
    {
        require(_mintAllowed, "Minting has been disabled");
