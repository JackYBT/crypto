...
contract Yuan is IERC20 {
    ...
    string public constant symbol = 'ETH';                 // TODO: Give your token a symbol
    string public constant name = 'Yuan';                   // TODO: Give your token a name
    ...
    uint public _emergency = 0;
    function _mint(uint amount) 
        public 
        AdminOnly
        returns bool
    {
        require _emergency == 0;
